...
//         let _2 := calldataload(0x04)
//         let notes := add(0x04, _2)
//         let _3 := 0x24
//         let m := calldataload(_3)
//         let n := calldataload(notes)
//         let _4 := 0x30644e72e131a029b85045b68181585d2833e84879b9709143e1f593f0000001
//         let _5 := 0x44
//         let challenge := mod(calldataload(_5), _4)
//         if gt(m, n)
//         {
//             mstore(0x00, 404)
//             revert(0x00, 0x20)
...
//         mstore(0x2c0, kn)
//         mstore(0x2e0, m)
//         kn := mulmod(sub(_4, kn), challenge, _4)
//         hashCommitments(notes, n)
//         let _7 := 7
//         let b := add(0x300, shl(_7, n))
//         let i := 0
//         for { } lt(i, n) { i := add(i, 0x01) }
//         {
//             let _8 := add(_2, mul(i, 0xc0))
//             let noteIndex := add(_8, _3)
//             let k := 0
//             let a := calldataload(add(_8, _5))
//             let c := challenge
//             let _9 := add(i, 0x01)
//             switch eq(_9, n)
//             case 1 {
//                 k := kn
//                 if eq(m, n) { k := sub(_4, kn) }
//             }
//             case 0 { k := calldataload(noteIndex) }
//             validateCommitment(noteIndex, k, a)
//             switch gt(_9, m)
//             case 1 {
//                 kn := addmod(kn, sub(_4, k), _4)
//                 let x := mod(mload(0), _4)
//                 k := mulmod(k, x, _4)
//                 a := mulmod(a, x, _4)
//                 c := mulmod(challenge, x, _4)
//                 mstore(0, keccak256(0, 0x20))
//             }
//             case 0 { kn := addmod(kn, k, _4) }
//             let _10 := 0x40
//             let _11 := 0xe0
//             calldatacopy(_11, add(_8, 164), _10)
//             let _12 := 0x20
//             calldatacopy(_12, add(_8, 100), _10)
//             let _13 := 0x120
//             mstore(_13, sub(_4, c))
//             let _14 := 0x60
//             mstore(_14, k)
//             mstore(0xc0, a)
//             let _15 := 0x1a0
//             let result := call(gas(), _7, 0, _11, _14, _15, _10)
//             let result_1 := and(result, call(gas(), _7, 0, _12, _14, _13, _10))
//             let _16 := 0x160
//             let result_2 := and(result_1, call(gas(), _7, 0, _1, _14, _16, _10))
//             let _17 := 6
//             let result_3 := and(result_2, call(gas(), _17, 0, _13, _1, _16, _10))
//             result := and(result_3, call(gas(), _17, 0, _16, _1, b, _10))
//             if eq(i, m)
//             {
//                 mstore(0x260, mload(_12))
//                 mstore(0x280, mload(_10))
//                 mstore(0x1e0, mload(_11))
//                 mstore(0x200, sub(0x30644e72e131a029b85045b68181585d97816a916871ca8d3c208c16d87cfd47, mload(0x100)))
//             }
//             if gt(i, m)
//             {
//                 mstore(_14, c)
//                 let _18 := 0x220
//                 let result_4 := and(result, call(gas(), _7, 0, _12, _14, _18, _10))
//                 let result_5 := and(result_4, call(gas(), _17, 0, _18, _1, 0x260, _10))
//                 result := and(result_5, call(gas(), _17, 0, _15, _1, 0x1e0, _10))
//             }
//             if iszero(result)
//             {
//                 mstore(0, 400)
...
//         if iszero(eq(mod(keccak256(_6, add(b, not(671))), _4), challenge))
//         {
//             mstore(0, 404)
//             revert(0, 0x20)
//         }
