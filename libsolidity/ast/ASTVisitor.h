...
public:
	...
	virtual bool visit(UserDefinedValueType& _node) { return visitNode(_node); }
	...
	virtual void endVisit(UserDefinedValueType& _node) { endVisitNode(_node); }
...
public:
	...
	virtual bool visit(UserDefinedValueType const& _node) { return visitNode(_node); }
	...
	virtual void endVisit(UserDefinedValueType const& _node) { endVisitNode(_node); }
